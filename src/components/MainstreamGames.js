  ...
  template: `
    <v-container fluid>
      ...
      <v-row>
        ...
        <v-col lg="3">
          <v-card color="blue-grey-lighten-4">
            <v-card-title>Respawn Entertainment</v-card-title>
            <v-card-text>
              <v-row>
                <v-col lg="12">
                  <v-card color="blue-grey-lighten-5">
                    <v-img src="assets/gamesps4/Titanfall 2.jpg" height="176.55" cover></v-img>
                    <v-card-text><b>Titanfall 2 (2016)</b></v-card-text>
                  </v-card>
                </v-col>
              </v-row>
            </v-card-text>
        ...
        <v-col lg="3">
          <v-card color="blue-grey-lighten-4">
            <v-card-title>MachineGames</v-card-title>
            <v-card-text>
              <v-row>
                <v-col lg="12">
                  <v-card color="blue-grey-lighten-5">
      ...
      <v-row>
        <v-col lg="6">
          <v-card color="blue-grey-lighten-4">
            <v-card-title>NetherRealm Studios</v-card-title>
            <v-card-text>
              <v-row>
                <v-col lg="6">
                  <v-card color="blue-grey-lighten-5">
                    <v-img src="assets/gamesps4/Injustice Gods Among Us.jpg" height="176.55" cover></v-img>
                    <v-card-text><b>Injustice: Gods Among Us (2013)</b></v-card-text>
                  </v-card>
                </v-col>
                <v-col lg="6">
                  <v-card color="blue-grey-lighten-5">
